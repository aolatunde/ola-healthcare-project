...
print("RUNNING SILVER NH HEALTHCITATIONS VERSION 001")
...
def write_control(status, records_read=0, records_written=0, error_message=""):
    record = [{
        ...
        "table_name": "silver_nh_healthcitations",
    ...
    control_df = spark.createDataFrame(record, schema=control_schema)
...
try:
    ...
    rename_map = {
        ...
        "deficiency_prefix": "deficiency_prefix",
        "deficiency_category": "deficiency_category",
        "deficiency_tag_number": "deficiency_tag_number",
        "deficiency_description": "deficiency_description",
        "scope_severity_code": "scope_severity_code",
        "deficiency_corrected": "deficiency_corrected",
        "correction_date": "correction_date",
        "inspection_cycle": "inspection_cycle",
        "standard_deficiency": "standard_deficiency",
        "complaint_deficiency": "complaint_deficiency",
        "infection_control_inspection_deficiency": "infection_control_inspection_deficiency",
        "citation_under_idr": "citation_under_idr",
        "citation_under_iidr": "citation_under_iidr",
        "location": "location",
    ...
    print("Silver NH health citations completed")
